...
/**
 * This aspect allows to use POJOs to generate semantic-web representations of data.
 * 
 * <br>
...
public interface SemanticAspect extends Aspect {
	 ...
	 * 
	 * @param obj
	 *          the object to be translated in semantic-web representation
	 ...
	 * 
	 * @param obj
	 *          thte object that has to be converted in an ontology (it may also be a collection of objects)
	 * @return an ontology representation of the given object
	 * @throws UnsupportedOperationException
	 *           if this implementation of the aspect does not support this operation
	 */
	 ...
	 * @throws UnsupportedOperationException
	 *           if this implementation of the aspect does not support this operation
	 * @throws SemanticQueryException
	 *           if this query cannot be translated in a Query
	 */
	...
	/**
	 * returns the supported semantic query languages supported by this implememtation. The first element of this array (if it is not
	 * empty) has to be the default query language.
	 * 
	 * @return the supported semantic query languages supported by this implememtation (an empty array if {@link #toQuery(String)} and
	 *         {@link #toQuery(String, String)} are not supported).
	 */

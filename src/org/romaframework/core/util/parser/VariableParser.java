...
public class VariableParser {
	...
	public static String resolveVariables(String iText, String iBegin, String iEnd, VariableParserListener iListener) {
		if (iListener == null)
		...
		if (resolved == null) {
			log.warn("[VariableParser.resolveVariables] Error on resolving property: " + var);
			resolved = "null";
		}
